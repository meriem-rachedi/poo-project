                ...
                if (action.equals("S")) {
                    ...
                    if (action.equals("L")) {
                        ...
                        while (!check) {
                            ...
                            patient = compte.rechercherPatientCompte(LC); //Obtenir les informations du patient depuis son compte
                        }
                    }
                }
                ...
                while (sortie == false) {
                    ...
                    if (choix.equals("R")) {
                        ...
                        do {
                            ...
                            verif = Patient.obtenirImmatriculesParNom(nomP, LP);
                            if (verif == false) {
                                System.out.println("Tappez R pour réessayer, Tappez S pour choisir un autre service");
                                a = scanner.next();
                            }
                        } while (verif == false && !a.equals("S"));
                        if (!a.equals("S")) {
